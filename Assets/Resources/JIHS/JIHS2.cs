...
public class JIHS : CogsAgent
{
    ...
    private void AssignBasicRewards()
    {
        ...
        rewardDict.Add("frozen", -2f);
        rewardDict.Add("shooting-laser", -1f);
        rewardDict.Add("hit-enemy", 2f);
        // rewardDict.Add("dropped-one-target", 5f);
        // rewardDict.Add("dropped-targets", 10f);
        rewardDict.Add("touching-wall", -0.5f);
        rewardDict.Add("dropped-no-targets", -2f);
